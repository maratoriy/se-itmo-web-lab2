...
Дополнительные фишки:
 - смена языка с масштабируемостью (i18n)
 - настроенные фильтры кидают сверстанную страницу при отсутствие ресурса (404) или если запрашиваемый ресурс мапается не к главному сервлету ControllerServlet (403)
 - полностью ajax обработка запросов, обновление страницы только по смене языка
 - адаптация под разные экраны
 - рисование области с помощью canvas с фиксом рендера с retina display
# Задание
